...
import www.will.persona.demo.repository.PersonaRepository;
...
/*
Como utilizamos JPA, debemos recordar que hay que implementar todos los metodos que vienen con el mismo.
"Asi no se vayan a usar".
 */
...
public class PersonaService  implements PersonaRepository {
    ...
    public List<Persona> findAllById(Iterable<Long> longs) {
        return personaRepository.findAllById(longs);
    }
